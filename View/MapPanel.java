...
public class MapPanel extends JPanel implements
  ...
  private class DeleteRoad implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      if (debug == true) System.out.println("============================ DELETE ROAD/NODES  ============");
      if (this.nodes != null) {
  ...
  static void		deleteRoad(RoadGraphic r) {
    ...
    if (controller.eventDeleteRoad(coord3, coord4) == false)
      System.out.println("MapPanel.deleteRoad(): Error: Road does not exist");
    if (debug == true) System.out.println("MapPanel.deleteRoad: Total road left: " + roads.size());
  }
  ...
  static void		deleteNode(NodeGraphic n) {
    ...
    if (nodes.contains(n) == true) {
      nodes.remove(n);
      if (debug == true) System.out.println("deleteNode: delete Node  ============");
  ...
  MapPanel(Controller controller) {
    ...
    // if (debug == true) System.out.println("Construction reussit");
  }
  ...
  public void		paintComponent(Graphics g) {
    ...
    // if (debug == true) System.out.println("x:" + view_x + " / y:" + view_y);
    ...
    while (++i < this.nodes.size()) {
      ...
      // if (debug == true) System.out.println("loop");
  ...
  private NodeGraphic		_displayMapNode(String s, int nodes_it)
  {
    ...
    if (newNode == null) // Create new node
    {
      ...
      nodes.add(newNode);
      if (debug == true) System.out.println("NODE --- Creating new graphic : " + _x + ":" + _y);
	...
	if (debug == true) System.out.println("NODE --- Changing graphic coord to real " + rel_x+":"+rel_y);
	// return (newNode);
      }
    }
  ...
  private VehiculeGraphic		_displayMapVehicule(String s)
  {
    ...
    if (this.graphVehicule == null) {
      if (debug == true) System.out.println("---> CREATE VEHICULE <----");
  ...
  private NodeGraphic		_displayMapUrgency(String s, int nodes_it)
  {
    ...
    if (newNode == null) // Create new node
    {
      ...
      // newNode.setGraphics(getGraphics());
      nodes.add(newNode);
      if (debug == true) System.out.println("NODE --- Creating new graphic URGENCY : " + _x + ":" + _y);
      // this.mapChanged = true;
    }
    else
    {
  ...
  private void		_displayMapRoad(String s, int road_it)
  {
    ...
    y1 = unScaleX(y1_real);
    y2 = unScaleX(y2_real);
    // if (debug == true) System.out.println("====> Adding road ");
    while (this.roads.size() <= road_it)
    {
      this.roads.add(new RoadGraphic(0, 0, 0, 0));
      if (debug == true) System.out.println("Adding graphical road ");
    }
  ...
  public void		displayMap(ArrayList<String> formatMap)
  {
    ...
    //       if (debug == true) System.out.println("Repaint");
    this.repaint();
  ...
  public void mouseReleased(MouseEvent e) {
    ...
    if (debug == true) System.out.println("MapPanel.mouseReleased()");
    if (e.getButton() == MouseEvent.BUTTON1
	...
	{
	  // if (debug == true) System.out.println("CREATE NODE GRAPHIC : " + e.getX() + " - " + e.getY());
  ...
  public void mousePressed(MouseEvent e) {
    if (debug == true) System.out.println("MapPanel.mousePressed");
    MapPanel.setIsDragging(false);
  ...
  public void	mouseDragged(MouseEvent e) {
    if (debug == true) System.out.println("MapPanel.mouseDragged");
	...
	&& this.movedMap == true) {
      for (NodeGraphic n : this.nodes) {
	if (debug == true) System.out.println("----->>>>>" + n.getx() + " + " + e.getX() + " - " + coordMouseOld[0]);
  ...
  static void	setMovedNode2(int x, int y) {
    ...
    if (debug == true) System.out.println("MapPanel.setMovedNode2");
  ...
  static void		setEndCoord(int x, int y, boolean b) {
    if (debug == true) System.out.println("MapPanel.setEndCoord");
    endCoord[0] = x;
    endCoord[1] = y;
  ...
  static void		moveNode(NodeGraphic n, int x, int y) {
    ...
    if (debug == true) System.out.println("MapPanel.moveNode");
  ...
  static Vector<String>	getUrgencyList(NodeGraphic n) {
    ...
    if (debug == true) System.out.println("MapPanel.getUrgencyList(): Error: 'n' is null");
