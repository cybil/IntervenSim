...
public class SelectAllButton extends JButton implements MouseListener{
  private String name;
  private Image img;
  ...
  SelectAllButton() {
    ...
    try {
      img = ImageIO.read(new File("img/selectallbutton.png"));
    } catch (IOException e) {
      e.printStackTrace();
    }
    this.setOpaque(false);
    this.addMouseListener(this);
    this.setToolTipText("Select all item");
  }
