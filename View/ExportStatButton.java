...
public class ExportStatButton extends JButton implements MouseListener{
  private String name;
  private Image img;
  ...
  ExportStatButton() {
    ...
    try {
      img = ImageIO.read(new File("img/exportstat2.png"));
    } catch (IOException e) {
      e.printStackTrace();
    }
    ...
    this.setToolTipText("Export Statictics");
  }
