...
public class Urgency implements java.io.Serializable {
  ...
  public void			setEndUrgencyDate(float newEndUrgencyDate) {
    if (debug == true) System.out.println("----> Set End Urgency <----");
  ...
  */
  ...
  {
    if (debug == true) System.out.println("Urgency.beginTreatment():");
    if (this.state == EUrgencyState.WAITING)
    {
      if (debug == true) System.out.println("Urgency.beginTreatment(): STATE IN_PROGRESS");
  ...
  */
  public boolean			Treatment()
  {
	...
	return (true);
      ...
      if (debug == true) System.out.println("Urgency.beginTreatment(): REDUCE TIME to " + UrgencyTreatmentTickLeft);
    }
    else
      System.out.println("Urgency.beginTreatment(): Error: this.state != EUrgencyState.WAITING");
    return (false);
  ...
  */
  ...
  {
    if (debug == true) System.out.println("Urgency.beginTreatment(): CANCEL");
    if (this.state == EUrgencyState.IN_PROGRESS)
    {
