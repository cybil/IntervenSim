...
public class Controller {
  ...
  public void			eventEditVehiculeCoord(int coord[]) {
    if (coord != null)
    _model.editVehiculeCoord(coord[0], coord[1]);
  }
  ...
  public int[]		eventGetAttachCoord() {
    return _model.getMap().getAttachPointCoord();
  }
